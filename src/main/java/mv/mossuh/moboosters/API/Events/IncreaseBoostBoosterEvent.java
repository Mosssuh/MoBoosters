...
public class IncreaseBoostBoosterEvent extends Event implements Cancellable {
    ...
    public IncreaseBoostBoosterEvent(DurationType durationType, Booster booster, Double boost) {
