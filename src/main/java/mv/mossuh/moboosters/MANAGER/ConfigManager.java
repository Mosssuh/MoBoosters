...
public class ConfigManager {
    ...
    private static MoConfig moBoostersData;
    public ConfigManager(MoBoosters main) {
        ...
        moBoostersData = new MoConfig("moboosters.db", main, "datas");
    }
    ...
    public void configure() {
        ...
        moBoostersData.registerConfig(false);
    ...
    public MoConfig getMoBoostersData() { return moBoostersData; }
