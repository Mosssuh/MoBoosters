...
public class SuperiorSkyblock2Data extends BoosterData<SuperiorSkyblock2Booster> {

    @Override
    protected String getTableName() {
        return "SuperiorSkyblock2Boosters";
    }
    ...
    @Override
    protected SuperiorSkyblock2Booster createBoosterFromRow(ResultSet rs) throws SQLException {
        ...
        BoosterIdentifier boosterIdentifier = new BoosterIdentifier(identifier, BoosterType.SUPERIORSKYBLOCK2, applicatorType, boosted);
        return new SuperiorSkyblock2Booster(uuid, boosterIdentifier);
    }

    @Override
    protected ActiveBooster toActiveBooster(SuperiorSkyblock2Booster booster, ResultSet rs) throws SQLException {
    ...
    @Override
    protected void setStatementValues(PreparedStatement ps, SuperiorSkyblock2Booster booster, Boost boost) throws SQLException {
    ...
    @Override
    protected void setStatementKey(PreparedStatement ps, SuperiorSkyblock2Booster booster) throws SQLException {
        BoosterIdentifier id = booster.getIdentifier();
        ps.setString(1, booster.getUUID().toString());
        ps.setString(2, id.getIdentifier());
        ps.setString(3, id.getApplicatorType().name());
